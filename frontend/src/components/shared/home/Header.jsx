...
export function Header() {
  return (
    <header className="relative bg-[#08312b] text-white flex flex-row lg:flex-row items-center justify-center px-5 md:px-12 py-2 h-[7vh]">
      ...
      <h1 className="text-center font-bold uppercase">Welcome To NUTUREMITE</h1>
    </header>
  );
}
