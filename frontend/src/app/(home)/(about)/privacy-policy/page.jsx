  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <p className="mb-4 text-gray-700">
        Welcome to Nutremite. This Privacy Policy explains how we
        collect, use, disclose, and safeguard your information when you visit
        our website nuturemite.info, and use our services. Please read this
      ...
      <ul className="list-disc list-inside text-gray-700 mb-4">
        <li>
          **Personal Data:** While using our website, we may ask you to provide
          us with certain personally identifiable information, such as your
          name, email address, phone number, and shipping address.
        </li>
        <li>
          **Usage Data:** We may also collect information on how you access and
          use our website, including your IP address, browser type, pages you
          visit, and the time and date of your visit.
        </li>
        <li>
          **Cookies:** We use cookies to enhance your experience. You can choose
          to accept or decline cookies, but this may prevent you from taking
      ...
      <p className="mb-4 text-gray-700">
        ...
        or serving our users, as long as those parties agree to keep this
      ...
      <p className="mb-4 text-gray-700">
        ...
        restrict its use. To exercise these rights, please contact us at [Email
        Address].
      </p>
      ...
      <p className="mb-4 text-gray-700">
        ...
        at  nuturemite.info or +91 891 999 3233 .
      </p>
    </div>
  );
};
